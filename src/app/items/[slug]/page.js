...
export async function generateMetadata({ params }) {
    ...
    const description = `Buy ${productName} at best price in India. Trusted supplier, dealer and distributor of ${productName} for hospitals, laboratories, diagnostic centers, research institutes and healthcare facilities. Contact Raj Biosis Private Limited Raj Biosis for latest quotation and product details.`;

    const url = `https://biohalos.com/items/${slug}`;
    ...
    return {
        ...
        metadataBase: new URL("https://biohalos.com"),
    };
}
