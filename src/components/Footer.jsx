...
export default function Footer() {
  ...
  useEffect(() => {
    const loadDistrict = async () => {
      ...
      try {
        const snap = await getDoc(
          doc(db, "websites", "biohaloscom", "districts", district)
        );
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i}>
                ...
                {[...Array(5)].map((_, j) => (
                  <div
                    key={j}
                    className="mb-4 h-5 animate-pulse rounded bg-slate-900"
                  />
                ))}
              </div>
            ))}
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mt-6 pt-4 border-t border-slate-800">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900 text-blue-400 shadow-sm transition-all duration-300 hover:scale-110 hover:bg-blue-600 hover:text-white"
                >
                  <FaFacebook size={18} />
                </a>
                ...
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900 text-pink-400 shadow-sm transition-all duration-300 hover:scale-110 hover:bg-pink-600 hover:text-white"
                >
                  <FaInstagram size={18} />
                </a>
              </div>
            ...
            <div className="flex flex-col gap-3 text-sm font-medium">
              {[
                ...
                <Link
                  ...
                  className="text-slate-400 transition-all duration-300 hover:translate-x-1.5 hover:text-white flex items-center gap-2"
                >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5 text-sm font-medium">
              ...
              <Link
                href={makeLink("/items")}
                className="mt-2 text-xs font-bold text-slate-300 hover:text-white hover:underline"
              >
                View Full Catalog →
              </Link>
            </div>
            ...
            <div className="space-y-4 text-slate-300">
              {dynamicAddress && (
                <div className="flex items-start gap-3">
                  ...
                  <p className="leading-6 text-sm text-slate-400">{dynamicAddress}</p>
                </div>
              )}
